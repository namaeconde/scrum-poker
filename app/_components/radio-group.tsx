...
export default function RadioGroup({ radioButtons }: RadioGroupProps) {
    return (
        <ul className="flex gap-2">
            <li>
                ...
                <label htmlFor="hosting-small"
                    ...
                    <svg className="w-5 h-5 ms-3 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                return (
                    <li>
                        ...
                        <label htmlFor="hosting-big"
                            ...
                            <svg className="w-5 h-5 ms-3 rtl:rotate-180" aria-hidden="true"
